...
class WindowPositionManager {
    ...
    private static let hasPreviouslyConfirmedScreenRecordingPermissionUserDefaultsKey = "com.jarvis.codex.hasPreviouslyConfirmedScreenRecordingPermission"
    ...
    static func recordConfirmedScreenRecordingPermission() {
        UserDefaults.standard.set(true, forKey: hasPreviouslyConfirmedScreenRecordingPermissionUserDefaultsKey)
    }
