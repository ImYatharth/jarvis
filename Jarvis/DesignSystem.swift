...
//  Jarvis
//
//  Centralized design system for Jarvis's soft-glass graphite shell.
...
enum DS {
    ...
    enum Colors {
        ...
        static let textSecondary = Color(hex: "#CBD1D5")

        /// Tertiary text — very muted, used for section labels, timestamps, disabled text.
        static let textTertiary = Color(hex: "#8C949B")
        ...
        static let accentText = Color.white.opacity(0.96)
        ...
        static let destructive = Color(hex: "#FF7878")

        /// Destructive hover state.
        static let destructiveHover = Color(hex: "#FF8B8B")

        /// Destructive used for text on dark backgrounds (brighter for readability).
        static let destructiveText = Color(hex: "#FF9D9D")
        ...
        static let overlayCursorBlue = Color(hex: "#F0F6FF")
...
// MARK: - Shared Jarvis Shell Primitives

struct DSGlassCardModifier<S: Shape>: ViewModifier {
    let shape: S
    var fillOpacity: Double = 0.44
    var borderOpacity: Double = 0.18
    var highlightOpacity: Double = 0.28
    var shadowOpacity: Double = 0.26
    var glowOpacity: Double = 0.06
...
extension View {
    func jarvisGlassCard<S: Shape>(
        shape: S,
        fillOpacity: Double = 0.44,
        borderOpacity: Double = 0.18,
        highlightOpacity: Double = 0.28,
        shadowOpacity: Double = 0.26,
        glowOpacity: Double = 0.06
    ) -> some View {
        modifier(
            DSGlassCardModifier(
                shape: shape,
...
// MARK: - Jarvis Waveform Visual Style

enum JarvisWaveformVisualStyle {
