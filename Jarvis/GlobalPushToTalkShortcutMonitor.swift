...
//  Jarvis
//
//  Captures push-to-talk keyboard shortcuts while Jarvis is running in the
...
final class GlobalPushToTalkShortcutMonitor: ObservableObject {
    let shortcutTransitionPublisher = PassthroughSubject<JarvisPushToTalkShortcut.ShortcutTransition, Never>()
    ...
    private func handleGlobalEventTap(
        ...
        let shortcutTransition = JarvisPushToTalkShortcut.shortcutTransition(
            for: eventType,
